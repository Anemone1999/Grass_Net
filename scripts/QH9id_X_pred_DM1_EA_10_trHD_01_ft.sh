...
rel_finetune_path="./outputs_main/X_pred/QH9/random/DM1_EA10_trHD_01/logs"
finetune_path=$(realpath -m "${root_path}/${rel_finetune_path}")
rel_finetune_ckpt_path="./outputs_main/X_pred/QH9/random/DM1_EA10_trHD_01/ckpts"
