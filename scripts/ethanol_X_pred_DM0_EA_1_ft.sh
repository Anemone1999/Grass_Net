...
rel_finetune_path="./outputs_models/SPHNet_X_pred_DM1_EA_0/logs"
finetune_path=$(realpath -m "${root_path}/${rel_finetune_path}")
rel_finetune_ckpt_path="./outputs_models/SPHNet_X_pred_DM1_EA_0/ckpts"
finetune_ckpt_path=$(realpath -m "${root_path}/${rel_finetune_ckpt_path}")


CUDA_VISIBLE_DEVICES=0 python pipelines/train.py \
