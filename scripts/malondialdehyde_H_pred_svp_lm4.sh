#!/bin/bash
# SPHNet-Hami: malondialdehyde def2-svp order=4 max_steps=200000 batch_size=32 (8:1:1 split)
...
OUTPUT_BASE="/home/pepe/workbench/basisset_scaling/spnethami_output/malondialdehyde_svp_$(date +%Y%m%d)"
