#!/bin/bash
# Task: hami*1 + grassd_loss(projection, clamped)*0.05
set -e
...
python pipelines/train.py \
  job_id=v2_projection_w0.05 \
  wandb.wandb_name=v2_projection_w0.05 \
  wandb.open=true \
  ...
  used_cache=false \
  precision=32 \
  "log_dir=/home/pepe/workbench/grassd_outputs/v2_projection_w0.05"
